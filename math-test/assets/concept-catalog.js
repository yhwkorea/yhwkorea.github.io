export const areas = [
  { id: 'cryptography', title: '현대 암호학', description: '암호화·AEAD·해시·MAC·키교환·서명·PQC의 역할', href: 'foundations/cryptography.html', concepts: ['public-key','private-key','authentication','integrity','encryption','digital-signature','hash-function','pqc'] },
