export const areas = [
  ...
  { id: 'algebra', title: '대수학', description: '군·환·아이디얼·몫환·체', href: 'foundations/algebra.html', concepts: ['binary-operation','closure-property','identity-element','inverse-element','group','abelian-group','subgroup','ring','commutative-ring','unit','zero-divisor','integral-domain','ideal','principal-ideal','quotient-ring','field'] },
