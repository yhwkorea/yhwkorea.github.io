export const areas = [
  ...
  { id: 'senior-math', title: '고등 심화 수학', description: '함수·복소수·미적분·행렬·벡터·확률', href: 'school/04-senior-secondary.html', concepts: ['trigonometry','complex-number','combinatorics','integral','matrix','vector'] },
  { id: 'cryptography', title: '현대 암호학', description: '보안 목표에서 TLS·NIST 표준·PQC 후보까지', href: 'foundations/cryptography.html', concepts: ['public-key','private-key','authentication','integrity','encryption','entropy','drbg','nonce','block-cipher','aes','aead','ascon','hash-function','mac','kdf','diffie-hellman','kem','ml-kem','hqc','digital-signature','certificate','tls13','ml-dsa','slh-dsa','fn-dsa','faest','hawk','mayo','mqom','qr-uov','sdith','snova','uov','pqc'] },
