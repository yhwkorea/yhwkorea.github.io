export const areas = [
  ...
  { id: 'elliptic-curves', title: '타원곡선', description: '곡선·특이점·무한원점·점 덧셈', href: 'isogeny/02-elliptic-curves.html', concepts: ['affine-plane','projective-plane','algebraic-curve','elliptic-curve','group-law','j-invariant','torsion','singular-point','point-at-infinity'] },
  { id: 'finite-fields', title: '유한체', description: 'Fₚ와 Fₚ²에서 계산하는 방법과 표수', href: 'isogeny/01-finite-fields.html', concepts: ['finite-field','extension-field','field','characteristic'] },
