export const areas = [
  ...
  { id: 'linear-algebra', title: '선형대수학', description: '벡터공간·행렬·선형변환·고유값', href: 'university/01-linear-algebra.html', concepts: ['matrix','vector','vector-space','subspace','linear-combination','span','linear-independence','basis','dimension','linear-transformation','null-space','range-linear-map','rank-nullity','inner-product','orthogonal-projection','eigenvalue','diagonalization','singular-value-decomposition'] },
  { id: 'probability', title: '확률론', description: '사건·조건부확률·확률변수·극한정리', href: 'university/02-probability.html', concepts: ['random-variable'] },
  { id: 'real-analysis', title: '실해석학', description: '실수·수열·극한·연속·적분의 엄밀한 기초', href: 'university/03-real-analysis.html', concepts: ['sequence-convergence'] },
  { id: 'number-theory', title: '정수론', description: '나눗셈·소수·합동식·유한체와 암호', href: 'university/04-number-theory.html', concepts: ['divisibility'] },
  { id: 'discrete-math', title: '이산수학', description: '논리·세기·그래프·점화식·알고리즘', href: 'university/05-discrete-math.html', concepts: ['combinatorial-proof'] },
  { id: 'differential-equations', title: '미분방정식', description: '변화 법칙·동역학·Laplace 변환·수치해', href: 'university/06-differential-equations.html', concepts: ['differential-equation'] },
  { id: 'topology', title: '위상수학', description: '열린집합·연속·연결·콤팩트성·기본군', href: 'university/07-topology.html', concepts: ['topological-space'] },
  { id: 'complex-analysis', title: '복소해석학', description: '정칙함수·복소적분·급수·유수', href: 'university/08-complex-analysis.html', concepts: ['holomorphic-function'] },
