export const areas = [
  ...
  { id: 'sqisign', title: 'SQIsign', description: '프로토콜의 결과, 서명 과정, 사원수 계산', href: 'isogeny/isogeny-textbook.html', concepts: ['sqisign','fiat-shamir','supersingular','quaternion-algebra','order'] },
  { id: 'isogeny', title: 'Isogeny', description: '곡선 사이 사상, 커널, 차수와 그래프', href: 'isogeny/03-isogenies.html', concepts: ['morphism','isogeny','kernel','degree','endomorphism'] },
  { id: 'elliptic-curves', title: '타원곡선', description: '곡선·특이점·무한원점·점 덧셈', href: 'isogeny/02-elliptic-curves.html', concepts: ['affine-plane','projective-plane','algebraic-curve','elliptic-curve','torsion','singular-point','point-at-infinity'] },
